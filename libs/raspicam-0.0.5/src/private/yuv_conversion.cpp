...
namespace raspicam {
    namespace _private{
        ...
        const unsigned int yuv2rgb565_table[768] =
        {
            /* y_table */
            0x7FFFFFEDU,
            0x7FFFFFEFU,
        ...
        void yuv420_2_rgb888 ( unsigned char  *dst_ptr,
            ...
            while ( height > 0 ) {
                ...
                while ( height < 0 ) {
                    ...
                    FIXUP ( y1 );
                    FIXUP ( y0 );
                    STORE_rgb( y1, &dst_ptr[dst_span] );
                    STORE_rgb( y0, dst_ptr );
                    dst_ptr += 3;
                    y1  = uv + READY ( y_ptr[y_span] );
                    y0  = uv + READY ( *y_ptr++ );
                    FIXUP ( y1 );
                ...
                if ( ( height>>16 ) == 0 ) {
                    ...
                    FIXUP ( y1 );
                    FIXUP ( y0 );
                    STORE_rgb( y0, &dst_ptr[dst_span] );
                    STORE_rgb( y1, dst_ptr );
                    dst_ptr += 3;
                }
        ...
        void yuv420_2_bgr888 ( unsigned char  *dst_ptr,
            ...
            while ( height > 0 ) {
                ...
                while ( height < 0 ) {
                    ...
                    FIXUP ( y1 );
                    FIXUP ( y0 );
                    STORE_bgr ( y1, &dst_ptr[dst_span] );
                    STORE_bgr ( y0, dst_ptr );
                    dst_ptr += 3;
                    y1  = uv + READY ( y_ptr[y_span] );
                    y0  = uv + READY ( *y_ptr++ );
                    FIXUP ( y1 );
                ...
                if ( ( height>>16 ) == 0 ) {
                    ...
                    FIXUP ( y1 );
                    FIXUP ( y0 );
                    STORE_bgr ( y0, &dst_ptr[dst_span] );
                    STORE_bgr ( y1, dst_ptr );
                    dst_ptr += 3;
                }
                dst_ptr += dst_span*2-width*3;
                y_ptr   += y_span*2-width;
